...
class LoginViewController: UIViewController {
    ...
    private let imageView: UIImageView = {
        ...
        imageVIew.image = UIImage(named: ImageViewStringConstants.logoName)
    ...
    private let loginButton: UIButton = {
        ...
        loginButton.setTitle(LoginButtonStringConstants.loginButtonTitle, for: .normal)
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        title = LoginStringConstants.title
